...
```{r edad_by_tdomest_by_ec, echo = FALSE, include = FALSE, fig.width = 5, fig.height = 3, fig.align = "center", fig.cap = "Gráfico de barras del campo de estuido en función del sexo", fig.pos = "H"}
